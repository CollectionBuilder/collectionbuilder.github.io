...
- Creating the [CollectionBuilder Examples Collection](https://collectionbuilder.github.io/cb-examples/) to demonstrate a variety of use cases for the CB framework and showcase CB projects from around the world

- Writing technical documentation to enhance and expand our learning materials, including the [step-by-step walkthroughs](https://collectionbuilder.github.io/cb-docs/docs/walkthroughs/) for CB-SHEETS, CB-GH, and CB-CSV
