...
## AI is Spooky ... 👻
{% capture caveat %}*The below is a pun- and emoji-filled riff I worked on with Claude (Opus 4.1) for Halloween, prompted by my  interest in Andrej Karpathy's recent description of LLMs as spirits/ghosts. Some of the puns are over my head ... *
