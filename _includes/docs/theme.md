...
- **home-banner-image-title** - This will create a tag for screen readers to describe the featured image. It's important for us to include accessibility features throughout. ***If you ever see an area that needs to more accessible, please let us know.***
...
- **stopwords** - set of subjects separated by ;, e.g. we use `boxers;boxing;boxer` for boxing collection because they're unnecessary. Really, this should probably be addressed in the metadata but sometimes metadata isn't perfect.
...
The about page is found at the base of the directory, where it's called "about.md". It's the only page file that will likely need your personal attention. More on writing the page can be found in our [finishing section](finshing.html#about).
